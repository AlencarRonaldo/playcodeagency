...
import { Achievement, UserProgress, AchievementNotification } from '@/domains/gaming/providers/types'
import { achievementManager } from '@/domains/gaming/providers/manager'
